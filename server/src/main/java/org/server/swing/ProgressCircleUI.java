...
public class ProgressCircleUI extends BasicProgressBarUI {
    ...
    public ProgressCircleUI(Progress pro) {
        this.pro = pro;
        imageDown = new ImageIcon(getClass().getResource("/org/chatapp/icon/down.png")).getImage();
        imageCancel = new ImageIcon(getClass().getResource("/org/chatapp/icon/cancel.png")).getImage();
        imageFile = new ImageIcon(getClass().getResource("/org/chatapp/icon/file.png")).getImage();
    }
