...
import org.chatapp.swing.JIMSendTextPane;
...
public class Chat_Bottom extends JPanel {
    ...
    private void init() {
        ...
        cmd.setIcon(new ImageIcon(getClass().getResource("/org/chatapp/icon/send.png")));
        cmd.addActionListener(ae -> eventSend(txt));
        JButton cmdMore = new JButton();
        cmdMore.setBorder(null);
        cmdMore.setContentAreaFilled(false);
        cmdMore.setCursor(new Cursor(Cursor.HAND_CURSOR));
        cmdMore.setIcon(new ImageIcon(getClass().getResource("/org/chatapp/icon/more_disable.png")));
        cmdMore.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                if (panelMore.isVisible()) {
                    ...
                    cmdMore.setIcon(new ImageIcon(getClass().getResource("/org/chatapp/icon/more.png")));
    ...
    private void eventSend(JIMSendTextPane txt) {
        ...
        if (!text.equals("")) {
            ModelSendMessage message = new ModelSendMessage(MessageType.TEXT, Service.getInstance().getUser().getId(), user.getId(), text);
            send(message);
